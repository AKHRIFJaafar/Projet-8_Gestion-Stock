  ...
  $.ajax({
    ...
    success:function(data) {
      ...
      for (var i = 0; i < studentsList.length; i++) {
        $(".studentsList").append('<li><h2>'+"Name: "+studentsList[i]["name"]+'</h2><h3>'+"FatherName: "+studentsList[i]["fathername"]+'</h3><h4>'+"Rollno: "+studentsList[i]["rollno"]+'</h4><h5>'+"Degree: "+studentsList[i]["degree"]+'</h5><h6>'+"Branch: "+studentsList[i]["branch"]+'</h6><span class="delete-btn">delete</span><input type="hidden" value="" class="stdID"></li>');
      }
    }
  })
}
